...
from Reminders import ReminderUtils
import coc
import re
...
class SetupCommands(cog , name="Setup"):
    ...
    @setup.sub_command_group(name="reminders")
    ...
    async def setup_reminders(self, ctx: disnake.ApplicationCommandInteraction,
                              ...
                              time_left: str = commands.Param(name="time_left"),
        ...
        #function = await function_dict[type_chose][type_to_edit]
        #next_move = function
    ...
    async def addClan(self, ctx: disnake.ApplicationCommandInteraction, clan: coc.Clan = commands.Param(converter=clan_converter), category: str = commands.Param(name="category"),
                member_role: disnake.Role = commands.Param(name="member_role"), leadership_role: disnake.Role = None, clan_channel: disnake.TextChannel = None):
        """
            Parameters
            ----------
    ...
    def gen_inactivity_times(self):
        all_times = ["24hr", "48hr", "72hr", "1week", "2weeks"]
